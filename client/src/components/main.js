    ...
    const add_steps = [
      ...step,
      {
        ...
        data: {
          ...
          isFolder: true,
          code: null,
          contains: willImportfile ? exploreContain : [],
        },
      },
    ];
    setStep(add_steps);
          ...
          <div className="flex flex-col w-full md:w-10/12 pl-1">
            ...
            <div className="block md:hidden">
              <div className="text-white grid grid-cols-2 justify-center gap-2 ">
                <div
                  className={`p-2 ${showEditor ? "" : "bg-orange-700"} `}
                  onClick={showFileTab}
                >
                  {!showNote ?"notes":"file"}
                </div>
           ...
           <div className={showNote ? 'block': 'hidden'}>
            ...
            <div className={`${showNote ? 'hidden': 'block'} text-white hover:text-orange-500`}>

                  <div className=" h-[80vh] overflow-y-scroll px-5 mx-auto relative">
                      
                   <span className="fixed right-10 cursor-pointer hidden md:block bottom-10 text-orange-500"><RiEditBoxFill size={40}/></span>
                  </div>
            </div>
          </div>
        </div>
