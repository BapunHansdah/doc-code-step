	...
	return(	
		<>
           <div className="max-w-full h-screen bg-lime-200">
              <div className="flex grid-cols-2 h-full shadow bg-black">
                {/*leftbar*/}
	           	   <div className="w-2/12 overflow-scroll scrollbar">
	           	     {
	           	     	step.map((s,ind)=>{
	           	     		return (
	           	   ...
	           	   <Modal className="max-w-[400px] w-[400px] mt-20 mx-auto bg-orange-500 rounded" isOpen={modal}>
	           	   ...
	           	   <div className="w-10/12 pl-1">
	           	      ...
	           	      <div className="flex">
	           	      	 <div className="bg-[#3d3d3d] w-full overflow-auto resize-x">
